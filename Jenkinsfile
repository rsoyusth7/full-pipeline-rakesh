pipeline {
    ...
    environment {
        ...
        IMAGE_NAME     = "fintech-python-app-rakesh" // Add your name here
        CONTAINER_NAME = "fintech-prod-container-rakesh" // Add your name here
        
        // ZAP Configuration
        ZAP_PORT       = "9002" // Change the port
        
        // Map Cosign Credentials
        COSIGN_PASSWORD = credentials('cosign-private-key')
        SONAR_SERVER_NAME = "sonar-server-admin"
        SONAR_PROJECT_KEY = "fintech-app-trainer-rakesh" // Add your name here
    }
